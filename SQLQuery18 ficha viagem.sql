SELECT        A.CdEmpresa AS EmpresaFicha, A.NrFicha, A.VlComissao, A.CdRotaRMS, B.DsNome AS MotoristaFV, C.DsNome AS ProprietarioFV, A.NrPlaca AS VeiculoFV, A.NrPlacaReboque1 AS CarretaFV, A.NrPlacaReboque2 AS Carreta2FV, 
                         A.NrPlacaReboque3 AS Carreta3FV, A.DsUsuarioCadastro AS UserFicha, D.CdEmpresaRom AS EmpresaRomaneio, D.CdRota AS RotaRomaneio, CAST(D.CdRomaneio AS varchar(20)) AS RomaneioManifesto, 
                         E.DsUsuario AS UserRomaneioManifesto, E.DtRomaneio AS DtEmissaoRmMan, E.NrPlaca AS VeiculoRmMan, E.NrPlacaReboque1 AS CarretaRmMan, E.NrPlacaReboque2 AS Carreta2RmMan, 
                         E.NrPlacaReboque3 AS Carreta3RmMan, F.DsNome AS MotoristaRmMan, G.DsNome AS ProprietarioRmMan, H.CdCartaFrete AS NumeroCTRB, I.DsUsuarioInc AS UserCtrb, I.DtEmissao AS DtEmissaoCTRB,
